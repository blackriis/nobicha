...
export function EmployeeReportsSection({ 
  ...
  if (isLoading) {
    return (
      <Card className="border border-border bg-background shadow-sm transition-colors duration-300">
        <CardHeader>
            ...
            >
              <div className="flex items-center gap-4 flex-1 transition-colors duration-300">
                ...
                <div className="relative">
                  <Avatar className="h-10 w-10 border border-border shadow-sm transition-colors duration-300">
